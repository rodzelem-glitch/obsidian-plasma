...
const FranchiseAgreementDoc: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 font-sans text-slate-800 dark:text-slate-300">
            <Helmet>
                <title>Master Services & Franchise Agreement | TekTrakker Legal</title>
                <meta name="description" content="Official White-Label Master Services and Franchise Agreement details for the TekTrakker platform." />
