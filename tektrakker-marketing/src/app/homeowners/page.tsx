...
export default function PropertyOwnerMarketing() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
            ...
            <div className="pt-32 md:pt-48 pb-20 text-center px-4 relative">
                ...
                <div className="relative z-10 max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col items-center">
                        <Link href="https://app.tektrakker.com/#/login?view=register_customer" className="w-full sm:w-auto px-8 md:px-12 py-5 bg-blue-600 text-white rounded-2xl font-black text-xl shadow-xl shadow-blue-500/30 hover:bg-blue-700 hover:shadow-2xl transition-all flex items-center justify-center gap-3">
                            Create Your Free Vault <ArrowRight size={24} />
                        </Link>
                        <Link href="https://app.tektrakker.com/#/login" className="mt-6 font-bold text-slate-500 hover:text-blue-600 transition-colors">
