...
export default function VirtualWorkerCommands() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
        ...
        <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900 font-sans">
            ...
            <header className="pt-48 pb-12 px-6 text-center">
                <div className="max-w-3xl mx-auto flex flex-col items-center">
                    <Image src="/mascot.webp" alt="AI Mascot" width={112} height={112} className="w-28 h-28 object-contain filter drop-shadow-xl mb-6" />
