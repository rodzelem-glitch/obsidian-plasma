    ...
    return (
        <footer className="bg-slate-950 border-t border-white/5 py-16 md:py-24 px-6 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-8 gap-y-16 relative z-10">
                ...
                <div className="col-span-1">
                    <h4 className="text-white font-bold mb-6 uppercase tracking-wider text-xs">Get The App</h4>
                    <p className="text-sm font-medium text-slate-400 mb-6">Take TekTrakker on the go. Available for iOS and Android.</p>
                    <div className="flex flex-col gap-3">
                        <a href="https://apps.apple.com/ph/app/tektrakker/id6761885811" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-white/5 text-white px-4 py-2 rounded-xl hover:bg-white/10 transition-colors border border-white/10">
                        ...
                        <a href="https://play.google.com/store/apps/details?id=com.tektrakker&pcampaignid=web_share" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-white/5 text-white px-4 py-2 rounded-xl hover:bg-white/10 transition-colors border border-white/10">
