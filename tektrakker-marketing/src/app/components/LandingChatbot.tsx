...
const LandingChatbot: React.FC = () => {
    ...
    - **Shared Device Kiosk Mode**: Easily support non-user employees who don't need a full software license.
    - **Automated Pay Tracking**: Timesheets are generated instantly from Kiosk Mode punches or field technician GPS records.
    ...
    const handleSend = async () => {
        ...
        try {
            // Ensure functions is initialized on the client
