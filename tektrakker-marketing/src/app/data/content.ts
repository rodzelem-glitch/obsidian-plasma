export const platformFeatures = {
    ...
    'field-service-app': {
        ...
        description: "Give your field team everything they need to succeed in the palm of their hand. The TekTrakker mobile app works offline, syncing job details, customer history, and complex forms without a hitch.",
        ...
        faq: [
            { q: "Is the app available on both iOS and Android?", a: "Yes, the TekTrakker app is available for download on both the Apple App Store and the Google Play Store." },
