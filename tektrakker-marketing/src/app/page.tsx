                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <div className="mt-6 flex flex-wrap gap-4 items-center">
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.tektrakker&pcampaignid=web_share" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-black text-white px-4 py-2.5 rounded-xl hover:bg-slate-800 transition-colors border border-slate-700 shadow-md hover:scale-105 duration-200">
                ...
                <div className="max-w-5xl mx-auto bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-3xl p-8 md:p-12 text-left flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group shadow-lg shadow-orange-500/5 mb-8 opacity-90">
                    ...
                    <div className="flex-1 relative z-10">
                        <div className="flex flex-wrap items-center gap-2 mb-4">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-100 text-orange-700 text-xs font-bold uppercase tracking-widest">Industry Leading Rates</div>
                        </div>
