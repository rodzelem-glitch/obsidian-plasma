...
export default function Home() {
    ...
    const startDemo = (role: string) => {
        if (typeof window !== 'undefined') {
            window.location.assign(`https://app.tektrakker.com/#/?demo=${role}`);
        }
    };
        ...
        <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-primary-500 selection:text-white">
                    ...
                    <div className="w-full max-w-4xl bg-white rounded-[2.5rem] border border-slate-200 p-4 md:p-8 md:p-12 relative shadow-2xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            {[
                                ...
                                <button key={opt.role} onClick={() => startDemo(opt.role)} className="p-6 rounded-3xl bg-slate-50 border border-slate-200 hover:border-primary-500 transition-all text-left group flex flex-col h-full hover:bg-slate-100 shadow-sm">
            ...
            <section className="py-20 px-6 text-center">
                ...
                <div className="max-w-5xl mx-auto bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-3xl p-8 md:p-12 text-left flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group shadow-lg shadow-orange-500/5 mb-8 opacity-90">
                    ...
                    <div className="flex-1 relative z-10">
                        <div className="flex flex-wrap items-center gap-2 mb-4">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-100 text-orange-700 text-xs font-bold uppercase tracking-widest">Keep More of Your Money</div>
                        ...
                        <h3 className="text-3xl font-black text-slate-900 mb-4">Stop Overpaying for Payment Processing</h3>
                        <p className="text-lg text-slate-600 mb-0">Don&apos;t need the full field service management system? Switch to our standalone invoicing platform and save thousands annually with our transparent, flat-rate pricing. No hidden fees, just instant payouts.</p>
                    </div>
                    <div className="relative z-10 w-full md:w-auto shrink-0">
                ...
                <div className="max-w-5xl mx-auto bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200 rounded-3xl p-8 md:p-12 text-left flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group hover:border-emerald-300 transition-colors shadow-lg shadow-emerald-500/5 mb-8">
                    ...
                    <Link href="https://app.tektrakker.com/#/login?view=register_business" className="flex-1 relative z-10 cursor-pointer block">
                        ...
                        <p className="text-lg text-teal-600 mb-0 leading-relaxed">
                            Have more jobs than you can handle? Need to keep your team busy during the slow season? Our integrated network allows you to instantly broadcast RFPs to trusted local contractors or bid on jobs they can&apos;t fulfill.
                        </p>
                    </Link>
                    <div className="relative z-10 w-full md:w-auto shrink-0 flex flex-col items-center">
                        <Link href="https://app.tektrakker.com/#/login?view=register_business" className="w-full md:w-auto px-8 py-4 bg-emerald-600 text-white font-black text-lg rounded-xl hover:bg-emerald-700 transition-all shadow-xl hover:shadow-2xl flex items-center justify-center gap-2 group-hover:scale-105">
