...
export default function VirtualWorkerMarketing() {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
        ...
        <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-indigo-500 selection:text-white">
            ...
            <section className="py-24 px-6 bg-slate-100">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 mb-16">
                    <Image src="/mascot.webp" alt="AI Mascot" width={160} height={160} className="w-40 h-40 object-contain filter drop-shadow-xl shrink-0" />
                ...
                <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-stretch justify-center gap-12">
                    <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left justify-center">
                        ...
                        <div className="flex flex-col items-center md:items-start w-full">
                            <Link href="https://app.tektrakker.com/#/login" className="h-16 px-12 rounded-2xl bg-slate-900 text-white font-black text-xl flex items-center justify-center gap-2 hover:bg-indigo-600 transition-colors shadow-xl hover:shadow-2xl hover:-translate-y-1">
                    ...
                    <div className="md:w-64 shrink-0 hidden md:flex items-center justify-center">
                        <Image src="/mascot.webp" alt="AI Mascot" width={256} height={380} className="max-h-[380px] h-full object-contain filter drop-shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:-translate-y-2 transition-transform duration-500" />
                    </div>
                </div>
            </section>
