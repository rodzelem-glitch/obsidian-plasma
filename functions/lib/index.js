...
exports.manageHandshake = exports.generateBidDocument = exports.searchHistoricalBidData = exports.analyzeRFP = exports.callGeminiAI = exports.callLandingChatbot = exports.deleteAuthUser = exports.sendSms = exports.getPlatformMetrics = exports.setUserRole = exports.generateCommissionOnSubscriptionPayment = void 0;
...
exports.callLandingChatbot = functions.https.onCall(async (data, context) => {
    ...
    if (!apiKey)
        throw new functions.https.HttpsError("internal", "AI service config error.");
