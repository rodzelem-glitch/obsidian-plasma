...
const VisualQCModal: React.FC<VisualQCModalProps> = ({ isOpen, onClose, onComplete }) => {
                        ...
                        {result && (
                            <div className={`p-6 rounded-3xl border-2 animate-scale-in ${
                                ...
                                <div className="mt-6 flex gap-3">
                                    {result.status === 'pass' ? (
                                        <Button onClick={() => onComplete('qc-pass-' + Date.now())} className="flex-1 bg-emerald-600 font-black uppercase text-xs tracking-widest">Submit as Passed</Button>
                                    ) : (
                                        <>
                                            <Button variant="secondary" onClick={reset} className="flex-1 font-black uppercase text-xs tracking-widest">Retry Photo</Button>
                                            <Button onClick={() => onComplete('qc-manual-' + Date.now())} variant="secondary" className="flex-1 bg-slate-800 text-white border-none font-black uppercase text-xs tracking-widest">Manual Override</Button>
                                        </>
                                    )}
                                </div>
                            </div>
