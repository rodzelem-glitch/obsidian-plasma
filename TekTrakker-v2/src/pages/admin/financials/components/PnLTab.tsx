    ...
    return (
        <Card>
            <div className="flex justify-between items-center mb-4">
                <h3 className="font-bold text-gray-800 dark:text-white flex items-center gap-2"><Calculator size={20}/> {t("Profit & Loss Statement")}</h3>
                <Button onClick={() => setIsReportModalOpen(true)} variant="secondary" className="text-xs flex items-center gap-2">
                    <Printer size={14}/> {t("Professional Report")}
                </Button>
            </div>
            <div className="space-y-4">
                <div className="bg-green-50 dark:bg-green-900/10 p-4 rounded-lg border border-green-100">
                    <div className="flex justify-between items-center mb-2">
                        <span className="font-black text-green-800 uppercase text-sm">{t("Total Income")}</span>
                ...
                <div className="bg-red-50 dark:bg-red-900/10 p-4 rounded-lg border border-red-100">
                    <div className="flex justify-between items-center mb-2">
                        <span className="font-black text-red-800 uppercase text-sm">{t("Total Expenses")}</span>
                 ...
                 <div className="bg-slate-100 dark:bg-slate-800 p-6 rounded-lg">
                    <div className="flex justify-between items-center">
                        <span className="font-black text-slate-800 dark:text-slate-200 uppercase text-lg">{t("Net Operating Income")}</span>
