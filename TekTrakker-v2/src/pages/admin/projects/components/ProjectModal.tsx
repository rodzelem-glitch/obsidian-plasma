...
const ProjectModal: React.FC<ProjectModalProps> = ({ isOpen, onClose, onSave, project, customers, employees }) => {
    const [projectForm, setProjectForm] = React.useState<Partial<Project>>({});
        ...
        <Modal isOpen={isOpen} onClose={onClose} title={projectForm.id ? "Edit Project" : "New Project"}>
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <Input label="Budget" type="number" value={projectForm.budget} onChange={e => setProjectForm({...projectForm, budget: Number(e.target.value)})} />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
