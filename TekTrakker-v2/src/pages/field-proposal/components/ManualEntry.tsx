    ...
    return (
        <div className="bg-blue-50 dark:bg-blue-900/10 p-6 rounded-2xl border border-blue-100 dark:border-blue-800 mb-8 animate-fade-in">
             ...
             <div className="flex flex-col md:flex-row gap-3 items-end [&_.mb-4]:!mb-0 [&_.mb-2]:!mb-0">
                 ...
                 <div className="w-full md:w-32">
                     <Input label={manualItem.isPercentage && (manualItem.type === 'Fee' || manualItem.type === 'Discount') ? "Percent (%)" : "Price ($)"} type="number" value={manualItem.price} onChange={e => setManualItem({...manualItem, price: e.target.value})} className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white" />
                 </div>
