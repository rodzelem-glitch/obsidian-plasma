...
export const LANDSCAPING_MASTER_BOOK: Omit<ProposalPreset, 'id' | 'organizationId'>[] = [
    ...
    { name: 'Lighting Transformer - 300W (Replace)', description: 'Supply and install pro-grade stainless steel multi-tap transformer.', baseCost: 285, avgLabor: 2.0, category: 'Landscape Lighting' },
    { name: 'Lighting Transformer - 600W (Replace)', description: 'Supply and install high capacity dual-tap transformer.', baseCost: 380, avgLabor: 2.5, category: 'Landscape Lighting' },
    { name: 'LED Path Light - Fixture Replace', description: 'Replace damaged low-voltage pathway light (Brass/Copper).', baseCost: 65, avgLabor: 0.75, category: 'Landscape Lighting' },
    { name: 'LED Up-Light / Spot - Fixture Replace', description: 'Replace damaged tree or architectural spot light.', baseCost: 85, avgLabor: 0.75, category: 'Landscape Lighting' },
    { name: 'Lighting Bulb Swap - LED Upgrade', description: 'Convert halogen bi-pin or wedge base to energy efficient LED.', baseCost: 10, avgLabor: 0.25, category: 'Landscape Lighting' },
    { name: 'Low Voltage Wire Repair - Direct Burial', description: 'Locate and splice cut lighting cable with waterproof connectors.', baseCost: 5, avgLabor: 1.5, category: 'Landscape Lighting' },
    { name: 'Lighting Photocell / Timer - Replace', description: 'Replace failed automatic dusk-to-dawn control module.', baseCost: 35, avgLabor: 1.0, category: 'Landscape Lighting' },
    { name: 'New Lighting Zone - Install (Per Fixture)', description: 'Trench wire and install new fixture (Fixture cost separate).', baseCost: 15, avgLabor: 1.5, category: 'Landscape Lighting' },
    ...
    { name: 'Sod Installation - Bermuda (Per Pallet)', description: 'Prep soil and install 450 sqft of Bermuda turf.', baseCost: 280, avgLabor: 5.0, category: 'Softscaping' },
    { name: 'Sod Installation - St. Augustine (Per Pallet)', description: 'Prep soil and install 450 sqft of premium shade turf.', baseCost: 350, avgLabor: 5.0, category: 'Softscaping' },
    { name: 'Sod Installation - Zoysia (Per Pallet)', description: 'Prep soil and install 450 sqft of Zoysia turf.', baseCost: 380, avgLabor: 5.0, category: 'Softscaping' },
    { name: 'Plant Installation - 1 Gallon Shrub', description: 'Dig, plant, fertilize and initial watering.', baseCost: 12, avgLabor: 0.4, category: 'Softscaping' },
    { name: 'Plant Installation - 3 Gallon Shrub', description: 'Dig, plant, fertilize and initial watering.', baseCost: 28, avgLabor: 0.6, category: 'Softscaping' },
    { name: 'Plant Installation - 15 Gallon Tree', description: 'Dig, plant, stake and mulch tree.', baseCost: 120, avgLabor: 1.5, category: 'Softscaping' },
    { name: 'Seasonal Color - Annuals (Per Flat)', description: 'Install flat of 18-20 seasonal flowers.', baseCost: 25, avgLabor: 1.0, category: 'Softscaping' },
    { name: 'Landscape Edging - Steel (Per LF)', description: 'Install heavy duty professional steel edging.', baseCost: 4.5, avgLabor: 0.15, category: 'Softscaping' },
    { name: 'Landscape Edging - Chop Stone (Per LF)', description: 'Install mortared stone border.', baseCost: 8, avgLabor: 0.5, category: 'Softscaping' },
    { name: 'Topsoil / Compost / Garden Mix (Per Yd)', description: 'Supply and spread soil for low spots or bed prep.', baseCost: 55, avgLabor: 1.5, category: 'Softscaping' },
    { name: 'Landscape Fabric Installation (Per Sqft)', description: 'Install professional weed barrier under rock/mulch.', baseCost: 0.20, avgLabor: 0.05, category: 'Softscaping' },

    // --- 11. DRAINAGE & EROSION CONTROL ---
    { name: 'French Drain Installation (Per LF)', description: 'Trench, gravel, perforated pipe, and backfill.', baseCost: 12, avgLabor: 1.0, category: 'Drainage' },
    { name: 'Downspout Extension - Buried (Per LF)', description: 'Connect gutter to underground solid PVC drain line to pop-up.', baseCost: 8, avgLabor: 0.75, category: 'Drainage' },
    { name: 'Catch Basin - 9x9 (Install)', description: 'Install drainage box in low spot for runoff collection.', baseCost: 45, avgLabor: 2.5, category: 'Drainage' },
    { name: 'Catch Basin - 12x12 (Install)', description: 'Install large drainage box in low spot.', baseCost: 65, avgLabor: 3.0, category: 'Drainage' },
    { name: 'Pop-Up Emitter Installation', description: 'Install discharge emitter at end of drain run.', baseCost: 25, avgLabor: 1.0, category: 'Drainage' },
    { name: 'Grading - Skid Steer (Per Hr)', description: 'Machine grading to correct positive drainage.', baseCost: 75, avgLabor: 1.0, category: 'Drainage' },
    { name: 'Dry Creek Bed Installation (Per LF)', description: 'Create rock drainage swale (Labor intensive).', baseCost: 35, avgLabor: 2.0, category: 'Drainage' },

    // --- 12. HARDSCAPE REPAIR ---
    { name: 'Paver Leveling - Small Area (to 25 sqft)', description: 'Lift pavers, add sand, level, and re-set.', baseCost: 25, avgLabor: 4.0, category: 'Hardscaping' },
    { name: 'Retaining Wall Repair - Re-Stack (Per Sqft)', description: 'Remove and re-install shifting block wall sections.', baseCost: 5, avgLabor: 2.0, category: 'Hardscaping' },
    { name: 'Flagstone Joint Repair (Per Sqft)', description: 'Remove loose mortar/sand and re-point joints.', baseCost: 2, avgLabor: 0.5, category: 'Hardscaping' },
    { name: 'Wall Stone Repair - Loose Caps', description: 'Clean and re-glue stone retaining wall caps.', baseCost: 15, avgLabor: 1.5, category: 'Hardscaping' },
