...
const ROUTE_CONFIG: Record<string, { title: string, subtitle: string, icon: any, bgClass: string }> = {
    ...
    '/admin/sales': { title: 'Proposals', subtitle: 'Manage leads and view active contract conversions.', icon: TrendingUp, bgClass: 'bg-gradient-to-r from-green-600 to-emerald-700' },
