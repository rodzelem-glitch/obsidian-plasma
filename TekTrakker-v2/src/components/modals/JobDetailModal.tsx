                                    ...
                                    {job.qcAudits && job.qcAudits.length > 0 && (
                                        <div className="space-y-3">
                                            {job.qcAudits.map((audit, i) => (
                                                <div key={i} className={`p-5 rounded-3xl border-2 ${
                                                    ...
                                                    <div className="flex items-start gap-4">
                                                        {audit.imageUrl && (
                                                            <div className="w-20 h-20 rounded-2xl overflow-hidden shadow-sm border border-white dark:border-slate-800 flex-shrink-0">
                                                        ...
                                                        <div className="flex-1">
                                                            ...
                                                            <p className="text-xs text-slate-700 dark:text-slate-300 font-bold leading-relaxed">{audit.comments}</p>
